...
Route::group(['middleware' => ['web']], function() {
	...
	Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('/dashboard/booker/customers/password-reset-link', 'Chuckbe\ChuckcmsModuleBooker\Controllers\CustomerController@passwordResetLink')->name('dashboard.module.booker.customers.get_password_reset_link');
        Route::post('/dashboard/booker/customers/email/update', 'Chuckbe\ChuckcmsModuleBooker\Controllers\CustomerController@email')->name('dashboard.module.booker.customers.update_email');
