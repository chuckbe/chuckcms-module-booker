...
@section('breadcrumbs')
	<ol class="breadcrumb">
		<li class="breadcrumb-item active"><a href="{{ route('dashboard.module.booker.services.index') }}">Diensten</a></li>
	</ol>
@endsection
...
<div class="container min-height p-3">
	...
	<div class="row bg-light shadow-sm rounded p-3 mb-3 mx-1">
		<div class="col-sm-12 text-right">
			<a href="#" data-target="#newServiceModal" data-toggle="modal" class="btn btn-sm btn-outline-success">Voeg Dienst Toe</a>
		</div>
...
@include('chuckcms-module-booker::backend.services._modal')
@endsection
