...
<div class="container min-height p-3">
        ...
        <div class="col-sm-12">
            <nav aria-label="breadcumb mt-3">
                <ol class="breadcrumb mt-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.module.booker.settings.index.subscriptions.statuses.edit', ['status' => $statusKey]) }}" class="">Status {{ ucfirst($statusKey) }}</a></li>
    ...
    <form action="{{ route('dashboard.module.booker.settings.index.subscriptions.statuses.email.save') }}" method="POST">
