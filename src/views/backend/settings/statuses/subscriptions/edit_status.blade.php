...
@section('content')
    <div class="container min-height p-3">
        ...
        <form action="{{ route('dashboard.module.booker.settings.index.subscriptions.statuses.update') }}" method="POST">
                ...
                <div class="col-sm-12 tab-pane fade" id="s_emails" role="tabpanel" aria-labelledby="s_emails-tab">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <a href="{{ route('dashboard.module.booker.settings.index.subscriptions.statuses.email.new', ['status' => $statusKey]) }}" class="btn btn-sm btn-outline-success">Nieuwe E-mail</a>
                        </div>
                    </div>
...
var remove_email_from_status_url = "{{ route('dashboard.module.booker.settings.index.subscriptions.statuses.email.delete') }}";
