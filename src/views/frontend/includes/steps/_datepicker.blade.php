<div class="cmb_datepicker_wrapper d-none">
	...
	<div class="splide" id="splide">
		<div class="splide__track">
			<div class="splide__list">
				...
				<div class="splide__slide datepicker_item border rounded mr-2" data-index="{{ $loop->index }}">
					<span class="d-block px-2 text-center">
						<small class="day">{{ $date->format('D') }}</small>
						<h6 class="font-weight-bold mb-0 number">{{ $date->format('d') }}</h6>
	...
	<div class="cmb_datepicker_timeslots_wrapper">
		<div class="form-group my-2">
			<span class="lead text-black font-weight-bold">Selecteer het gewenste uur</span>
		</div>
