	...
	<div class="row checkbox-type">
		...
		<div class="col-md-12{{ !$loop->last ? ' mb-2' : '' }}">
			<div class="py-2 px-3 border rounded row no-gutters g-0">
				...
				<span class="col-md-1 text-right text-end collapsed" type="button" data-toggle="collapse" data-target="#service_description{{ $service->id }}" aria-expanded="false" aria-controls="service_description{{ $service->id }}"><i class="fa fa-chevron-down"></i></span>
