...
input[name="cmb_subscription_plan"][type="checkbox"]
{
    opacity: 0;
    position: absolute;
    width: 0;
...
input[name="cmb_subscription_plan"][type="checkbox"] + span
{
...
input[name="cmb_subscription_plan"][type="checkbox"] + span::before
{
    content: "";
    width: 20px;
    height: 20px;
...
input[name="cmb_subscription_plan"][type="checkbox"]:checked + span::before
{
    color: #666;
   /* background-color: blue;*/
}
 
input[name="cmb_subscription_plan"][type="checkbox"]:disabled + span
{
    cursor: default;
