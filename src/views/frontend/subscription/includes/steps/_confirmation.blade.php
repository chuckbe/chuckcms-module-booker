<div class="cmb_confirmation_wrapper d-none">
	<div class="form-group mb-2">
		...
		@endguest
		<span class="d-block lead text-black font-weight-bold fw-bold">Gegevens </span>
	</div>
	...
	<div class="row">
		<div class="form-group mb-2 col-12">
			...
			<small class="cmb_email_suggestion text-muted float-right float-end d-none">Bedoel je misschien <a href="#" class="cmb_email_suggestion_link text-dark"></a>?</small>
			<small class="cmb_email_correction text-muted float-right float-end d-none">Verbeter je e-mailadres.</small>
		</div>
	</div>
	<div class="row">
		<div class="form-group mb-2 col-12">
	...
	<div class="row">
		<div class="form-group col-12">
			...
			<label class="mb-0" for="cmb_create_customer">
				<small>
					<input type="checkbox" class="mr-2 me-2" name="create_customer" id="cmb_create_customer" checked disabled> Ik wil een account aanmaken
				</small>
			</label>
			<div class="w-100 d-block"></div>
			<div class="cmb_create_customer_password_wrapper">
	...
	<div class="cmb_confirmation_overview_section py-2 px-3 border rounded row no-gutters g-0 mb-2">
		<div class="col-sm-12 mb-2">
			<span class="font-weight-bold fw-bold d-block"><span class="cmb_confirmation_sub_plan_text">Subscription Plan</span></span>
			<small class="mr-2 me-2"><i class="fa fa-calendar"></i> <span class="cmb_confirmation_type_text">Maandelijks</span></small>
	...
	<div class="form-group">
		...
		<button class="btn btn-dark btn-large btn-block w-100" id="cmb_confirmation_booker_btn">Betalen & Bevestigen</button>
	</div>
</div>