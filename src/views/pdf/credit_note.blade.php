...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>CREDIT NOTA {{ ChuckModuleBooker::getSetting('credit_note.prefix') . str_pad($appointment->json['credit_note'], 4, '0', STR_PAD_LEFT) }}</title>
    ...
    <main>
      <div id="details">
        <div style="width:auto;height:auto;margin: 0 auto;">
          ...
          <div id="invoice">
            <h1 style="color:#000;">CREDIT NOTA {{ ChuckModuleBooker::getSetting('credit_note.prefix') . str_pad($appointment->json['credit_note'], 4, '0', STR_PAD_LEFT) }}</h1>
      ...
      <div>
        <p>Dit is een credit nota voor factuur {{ ChuckModuleBooker::getSetting('invoice.prefix') . str_pad($appointment->json['invoice_number'], 4, '0', STR_PAD_LEFT) }}.</p>
      </div>
      <br><br>
      ...
      <div class="page-break">
        <div style="color:#000;" id="thanks">Opmerking:</div>
        <div class="notice">
