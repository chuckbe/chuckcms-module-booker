...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>CREDIT NOTA {{ ChuckModuleBooker::getSetting('credit_note.prefix') . str_pad($subscription->json['credit_note'], 4, '0', STR_PAD_LEFT) }}</title>
  ...
  <body>
    ...
    <footer>
      ...
      Vragen bij deze credit nota? Contacteer ons op {{ ChuckSite::getSetting('company.email') }}
    ...
    <main>
      <div id="details">
        <div style="width:auto;height:auto;margin: 0 auto;">
          <div id="client">
            <div class="to">CREDIT NOTA VOOR:</div>
          ...
          <div id="invoice">
            <h1 style="color:#000;">CREDIT NOTA {{ ChuckModuleBooker::getSetting('credit_note.prefix') . str_pad($subscription->json['credit_note'], 4, '0', STR_PAD_LEFT) }}</h1>
      ...
      <div>
        <p>Dit is een credit nota voor factuur {{ ChuckModuleBooker::getSetting('invoice.prefix') . str_pad($subscription->json['invoice_number'], 4, '0', STR_PAD_LEFT) }}.</p>
      </div>
      <br><br>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
              ...
              <td class="qty">1</td>
              <td class="qty">21%</td>
              <td class="unit">- {{ ChuckModuleBooker::formatPrice(ChuckModuleBooker::taxFromPrice($subscription->json['credit_price'], 21)) }}</td>
              <td class="total">- {{ ChuckModuleBooker::formatPrice($subscription->json['credit_price']) }}</td>
            </tr>
        ...
        <tfoot class="page-break">
          <tr>  
            ...
            <td>- {{ ChuckModuleBooker::formatPrice(ChuckModuleBooker::priceWithoutTax($subscription->json['credit_price'], 21)) }}</td>
          </tr>
          ...
          <tr>  
            ...
            <td>- {{ ChuckModuleBooker::formatPrice(ChuckModuleBooker::taxFromPrice($subscription->json['credit_price'], 21)) }}</td>
          </tr>
          
          <tr>
            <td colspan="1"></td>
            <td style="color:#000;" colspan="4">TOTAAL</td>
            <td style="color:#000;">- {{ ChuckModuleBooker::formatPrice($subscription->json['credit_price']) }}</td>
          </tr>
        </tfoot>
      </table>
      ...
      <div class="page-break">
        <div style="color:#000;" id="thanks">Opmerkingen:</div>
        <div class="notice">
          Indien het bedrag nog niet werd overgemaakt zullen wij dit zo spoedig mogelijk overmaken op de rekeningnummer waarmee er initieel betaald werd.
        </div>
        <br/><br/>
      </div>
